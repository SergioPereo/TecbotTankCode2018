 ...
 * 
 * Implemented the class TecbotSpeedController by Sergio Pereo
 * 
...
public class RobotDrive implements MotorSafety {
  ...
  protected TecbotSpeedController m_frontLeftMotor;
  protected TecbotSpeedController m_frontRightMotor;
  protected TecbotSpeedController m_rearLeftMotor;
  protected TecbotSpeedController m_rearRightMotor;
  protected TecbotSpeedController m_middleRightMotor;
  protected TecbotSpeedController m_middleLeftMotor;
  ...
  public RobotDrive(final int leftMotorChannel, final int rightMotorChannel) {
    ...
    m_rearLeftMotor = new TecbotSpeedController(leftMotorChannel,false);
    m_frontRightMotor = null;
    m_rearRightMotor = new TecbotSpeedController(rightMotorChannel,false);
  ...
  public RobotDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
    ...
    m_sensitivity = kDefaultSensitivity;
    m_maxOutput = kDefaultMaxOutput;
    m_rearLeftMotor = new TecbotSpeedController(rearLeftMotor,false);
    m_rearRightMotor = new TecbotSpeedController(rearRightMotor,false);
    m_frontLeftMotor = new TecbotSpeedController(frontLeftMotor,false);
    m_frontRightMotor = new TecbotSpeedController(frontRightMotor,false);
    m_middleLeftMotor = null;
    m_middleRightMotor = null;
    m_allocatedSpeedControllers = true;
    setupMotorSafety();
  ...
  public RobotDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
    ...
    m_frontLeftMotor = new TecbotSpeedController(frontLeftMotor,false);
    m_frontRightMotor = new TecbotSpeedController(frontRightMotor,false);
    m_middleLeftMotor = new TecbotSpeedController(middleLeftMotor,false);
    m_middleRightMotor = new TecbotSpeedController(middleRightMotor,false);
    m_allocatedSpeedControllers = true;
    setupMotorSafety();
    drive(0, 0);
  }
   ...
   */
  public RobotDrive(TecbotSpeedController leftMotor, TecbotSpeedController rightMotor) {
   ...
   */
  public RobotDrive(TecbotSpeedController frontLeftMotor, TecbotSpeedController rearLeftMotor,
		  			TecbotSpeedController frontRightMotor, TecbotSpeedController rearRightMotor) {
